                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="au-card shadow-lg p-3 m-3">
                                <div class="card-body">
                                    <h3 class="card-title">Selamat Datang di Halaman Pendaftaran</h3>
                                    <p class="card-text">Silakan Daftar dulu</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            ...
                                            <form action="" method="post">
												...
												<div>
													...
													<a href="<?= site_url('auth/login') ?>" class="">Login Akun</a>
												</div>

												<div class="d-grid">
													<input type="submit" class="btn btn-primary btn-login" value="Daftar">
												</div>
											</form>
                                        </div>
                                    </div>
