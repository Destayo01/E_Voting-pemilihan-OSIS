                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Pemilih</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Tabel data pemilih</h2>
                                    </div>
                                    <div class="card-body">
                                        <!-- Overview Wrap -->
                                        <div class="table-data__tool-right">
                                            <a href="<?= site_url('admin/pemilih/tambah') ?>">
                                                <button class="btn btn-outline-primary btn-sm">
                                                    <i class="fa fa-plus"></i> Tambah
                                                </button>
                                            </a>
                                            <a href="<?= site_url('admin/pemilih/hapus_semua/'); ?>">
                                                <button class="btn btn-outline-danger btn-sm">
                                                    <i class="fa fa-trash"></i> Hapus Semua Tabel
                                                </button>
                                            </a>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <!-- Form Import Data -->
                                                <div class="col-md-6">
                                                    <form action="<?= site_url('admin/Pemilih/uploaddata') ?>" method="post" enctype="multipart/form-data" class="my-3">
                                                ...
                                                <!-- Form Pencarian -->
                                                <div class="col-md-6">
                                                    <form action="<?= site_url('admin/pemilih/cari'); ?>" method="get" class="my-3">
                                                            <div class="input-group">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($pemilih as $row): ?>
                                                                <tr class="tr-shadow">
                                                                    ...
                                                                    <td><?= $row->tanggal ?></td>
                                                                    <td>
                                                                        <?php if ($row->status == 'Sudah Memilih'): ?>
                                                                            <span class="badge badge-success" style="font-size: 14px"><?= $row->status ?></span>
                                                                        <?php else: ?>
                                                                            <span class="badge badge-danger" style="font-size: 14px"><?= $row->status ?></span>
                                                                        <?php endif; ?>
                                                                    </td>
                                                                    <td>
                                                                        <div class="table">
                                                                            <a href="<?= site_url('admin/pemilih/reset_status/' . $row->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="top" title="Resert">
                                                                                <i class="fa fa-refresh"></i>
                                                                            </a>
                                                                            <a href="<?= site_url('admin/pemilih/edit/' . $row->id) ?>" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                            ...
                                                                            <button class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete" onclick="confirmDelete(<?= $row->id; ?>)">
                                                                                <a href="<?= site_url('admin/pemilih/hapus/' . $row->id) ?>">
    ...
    function confirmDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Operasi penghapusan
                $.ajax({
                    url: "<?= site_url('admin/pemilih/hapus/'); ?>" + id,
                    method: "POST",
