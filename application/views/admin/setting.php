                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        ...
                                        <div class="au-card">
											...
											<div class="card-header">
												...
												<div style="display: flex; gap: 1em">
													<a href="<?= site_url('admin/setting/remove_avatar') ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i> Remove Avatar</a>
													<a href="<?= site_url('admin/setting/upload_avatar') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i> Change Avatar</a>
												</div>
											</div>
											<div class="card-body">
												<?php
										...
										<div class="card">
											<div class="card-header" style="display: flex; gap: 1em">
												<strong>Profile Settings</strong>
												<a href="<?= site_url('admin/setting/edit_profile') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i>Edit Profile</a>
											</div>
											<div class="card-body">
										...
										<div class="card">
											<div class="card-header">
												...
												<a href="<?= site_url('admin/setting/edit_password') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i>Edit Password</a>
											</div>
											<div class="card-body">
