                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Edit kelas</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="post" action="<?= base_url('admin/kelas/edit/' . $kelas->id) ?>" class="">
                                            <div class="form-group">
                                                <label for="nf-nama_kelas" class="form-control-label">Nama Kelas</label>
                                                <input type="text" id="nf-nama_kelas" name="nama_kelas" value="<?= $kelas->nama_kelas ?>" class="form-control" required>
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-tingkat" class="form-control-label">Tingkat</label>
                                                <input type="text" id="nf-tingkat" name="tingkat" value="<?= $kelas->tingkat ?>" class="form-control" required>
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <button type="reset" class="btn btn-danger btn-sm">
                                                    <a href="<?= site_url('admin/kelas') ?>" style="color: white; text-decoration: none;">
