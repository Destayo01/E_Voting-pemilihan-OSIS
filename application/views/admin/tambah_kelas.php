                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Tambah kelas</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="<?= base_url('admin/kelas/create') ?>" method="post" class="">

                                            <div class="form-group">
                                                <label for="nama_kelas" class=" form-control-label">Class Name</label>
                                                <input type="text" id="nama_kelas" name="nama_kelas" placeholder="Enter Class Name.." class="form-control" required>
                                                
                                            </div>

                                            <div class="form-group">
                                                <label for="tingkat" class=" form-control-label">Level</label>
                                                <input type="text" id="tingkat" name="tingkat" placeholder="Enter Level.." class="form-control" required>
