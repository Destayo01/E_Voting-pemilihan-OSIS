                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Edit kandidat</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Edit kandidat</h2>
                                    </div>
                                    <div class="card-body">
                                <!-- DATA TABLE -->
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit Kandidat</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        ...
                                        <form method="POST" action="<?= base_url('admin/kandidat/edit/' . $kandidat['id']) ?>" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="nisn">NISN</label>
                                                <input type="text" class="form-control" name="nisn" value="<?= $kandidat['nisn'] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input type="text" class="form-control" name="nama" value="<?= $kandidat['nama'] ?>" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="visi" rows="4" required><?= $kandidat['visi'] ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="misi">Misi</label>
                                                <textarea class="form-control" name="misi" rows="4" required><?= $kandidat['misi'] ?></textarea>
                                            </div>
                                        ...
                                        <button type="reset" class="btn btn-danger btn-sm">
                                            <a href="<?= site_url('admin/kandidat') ?>" style="color: white; text-decoration: none;">
