                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Edit username</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Edit username</h2>
                                    </div>
													...
													<form action="" method="POST" class="form-horizontal">
														<div class="row form-group">
															...
															<div class="col-12 col-md-9">
																<input type="text" id="name" name="name" class="form-control <?= form_error('name') ? 'is-invalid' : '' ?>"
																	value="<?= form_error('name') ? set_value('name') : $current_user->name ?>" required maxlength="32">
														...
														<div class="row form-group">
															...
															<div class="col-12 col-md-9">
																<input type="text" id="email" name="email" class="form-control <?= form_error('email') ? 'is-invalid' : '' ?>"
																	value="<?= form_error('email') ? set_value('email') : $current_user->email ?>" required maxlength="32">
																<div class="invalid-feedback">
																	<?= form_error('email') ?>
																</div>
															</div>
