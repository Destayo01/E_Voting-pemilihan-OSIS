                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Tambah pemilih</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">tambah pemilih</h2>
                                    </div>
                                    <div class="card-body">
                                            <!-- DATA TABLE -->
                                        <div class="au-card">
                                            <div class="card-header">
                                                <strong>Tambah pemilih</strong>
                                            </div>
                                        <div class="card-body card-block">
                                            <form action="<?= site_url('admin/pemilih/simpan') ?>" method="post" class="">
                                                <div class="form-group">
                                                    <label for="nisn" class="form-control-label">NISN</label>
                                                    <input type="text" id="nisn" name="nisn" placeholder="Enter NISN.." class="form-control" required>
                                                </div>
                                                <div class="form-group">
