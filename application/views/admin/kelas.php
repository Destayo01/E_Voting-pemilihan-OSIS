                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Tabel data Kelas</h2>
                                    </div>
                                    <div class="card-body">
                                        <!-- Overview Wrap -->
                                        <div class="table-data__tool-right">
                                        <a href="<?= site_url('admin/kelas/create') ?>">
                                        <button class="btn btn-outline-primary btn-sm">
                                        <i class="fa fa-plus"></i> Tambah</button></a>
                                        <a href="<?= site_url('admin/kelas/hapus_semua/'); ?>">
                                        ...
                                        <i class="fa fa-trash"></i> Hapus Semua Tabel</button></a>
                                            ...
                                            <!-- Form Import Data -->
                                                <div class="col-md-6">
                                                    <form action="<?= site_url('admin/kelas/uploaddata') ?>" method="post" enctype="multipart/form-data" class="my-3">
                                                ...
                                                <!-- Form Pencarian -->
                                                <div class="col-md-6">
                                                    <form action="<?= site_url('admin/kelas/cari'); ?>" method="get" class="my-3">
                                                            <div class="input-group">
                                                    ...
                                                    <table class="table table-data2">
                                                        ...
                                                        <?php foreach ($kelas as $row): ?>
                                                            <tr class="tr-shadow">
                                                                ...
                                                                <td>
                                                                <div class="table">
                                                                        <a href="<?= base_url('admin/kelas/edit/' . $row->id) ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i>
                                                                        </a>
                                                                        <button class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete" onclick="confirmDelete(<?= $row->id; ?>)">
                                                                                <a href="<?= base_url('admin/kelas/delete/' . $row->id) ?>">
    ...
    function confirmDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Operasi penghapusan
                $.ajax({
                    url: "<?= site_url('admin/kelas/delete/'); ?>" + id,
                    method: "POST",
