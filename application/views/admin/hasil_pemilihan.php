                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Hasil pemilihan</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Hasil pemilihan</h2>
                                    </div>
                                    <br>
                                    <div class="container">
                                        <div class="row">
                                        ...
                                        <div class="au-card">
                                            <div class="card-body">
                                            <div class="card-header">
                                        <h2 class="title">Tabel data Pemilihan</h2>
                                    </div>
                                    <div class="card-body">
                                    <a href="<?= site_url('admin/hasil/hapus_semua/'); ?>">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <!-- Form Pencarian -->
                                                <div class="col-md-6">
                                                    <form action="<?= site_url('admin/hasil/cari'); ?>" method="get" class="my-3">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Cari NISN dan ID" name="q">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($hasil as $row): ?>
                                                                <tr class="tr-shadow">
                                                                    ...
                                                                    <td>
                                                                        <div class="table">
                                                                            <a href="javascript:void(0);" onclick="confirmDelete('<?= $row->id; ?>')" class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    function confirmDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Operasi penghapusan
                $.ajax({
                    url: "<?= site_url('admin/hasil/delete/'); ?>" + id,
                    method: "POST",
