                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Tambah kandidat</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-card">
                                    <div class="card-header">
                                        <h2 class="title">Tambah kandidat</h2>
                                    </div>
                                    <div class="card-body">
                                <!-- DATA TABLE -->
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Tambah</strong> Kandidat
                                    </div>
                                    <div class="card-body card-block">
                                        ...
                                        <form method="POST" action="<?= base_url('admin/kandidat/create') ?>" enctype="multipart/form-data" class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="visi" rows="4" required></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="misi" class="form-control-label">Misi</label>
                                                <textarea class="form-control" name="misi" rows="4" required></textarea>
                                            </div>
